...
#include "implot_candlestick.cpp"
#include <stdio.h>
...
int main(int, char**)
{
    ...
    bool show_profile_data = false;
    bool show_stock = false;
...
#endif
    {
        ...
        if (show_login_window) {
            ...
            ImGui::Begin("Log in");                          // Create a window called "Hello, world!" and append into it.
            
            ImGui::Text("Please log in to start");               // Display some text (you can use a format strings too)
            char buf[255]{};
            {   
            ...
            if (ImGui::Button("Log in"))  {
                // checking username and password will be here
        ...
        {
            ImGui::Begin("My profile");  
            
            ImGui::Text("Name:");
            ImGui::Text("Capital:");
            ImGui::Text("Favourites");
            const char* items[] = { "Stock1", "Stock2" }; // Here will be favourite stocks, now temporarily it is a collection of stings
            ...
            if (current_item) {
                ...
                if (ImPlot::BeginPlot(current_item,ImVec2(-1,0))) {
            ...
            ImGui::Button("Search for other stock");
            ImGui::End();
