...
```
cd existing_repo
git remote add origin https://gitlab-stud.elka.pw.edu.pl/aprzybor/proi.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-stud.elka.pw.edu.pl/aprzybor/proi/-/settings/integrations)
